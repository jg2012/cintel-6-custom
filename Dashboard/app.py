...
with ui.sidebar(id="sidebar_left", open="desktop"):
    ui.HTML('<h3 style="font-size: medium;">Filter Options</h3>')  # Fixed the style attribute
    with ui.accordion():  # Add the accordion() call to group the AccordionPanel instances
